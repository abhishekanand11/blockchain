...
/**
 * Wallet class used to hold the wallet data
 * 
 * @author abhanand
 *
 */
public class Wallet {
	...
	public Map<String, TransactionOutput> UTXOs = new HashMap<String, TransactionOutput>(); // only UTXOs owned by this
																							// wallet.
	...
	public float getBalance() {
		float total = 0;
		for (Map.Entry<String, TransactionOutput> item : BlockChainDriver.UTXOs.entrySet()) {
